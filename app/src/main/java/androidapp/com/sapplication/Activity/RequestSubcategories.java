...
import androidapp.com.sapplication.Adapter.ReqSubcategoriesAdapter;
import androidapp.com.sapplication.Adapter.SubcategoriesAdapter;
...
public class RequestSubcategories extends AppCompatActivity {
    ...
    TextView blank_text_sc,txt_cat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_subcategory.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                SubCategoryList bean = scList.get(position);
